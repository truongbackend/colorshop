            ...
            <div class="get_in_touch_contents">
                ...
                <form action="{{ route("contact.store") }}" method="POST">
                    ...
                    <div>
                        ...
                        <input id="input_website" class="form_input input_website input_ph" type="text" name="phone" placeholder="Số điện thoại" required="required" data-error="Số điện thoại.">
