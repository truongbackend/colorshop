                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item="" class="outer">
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="taskname" name="title" value="{{ $banner->title }}" type="text" class="form-control" placeholder="Tiêu đề của bài...">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Chi tiết</label>
                                <div class="col-lg-10">
                                    <input id="taskname" value="{{ $banner->description }}" name="description" type="text" class="form-control" placeholder="Tiêu đề của bài...">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
