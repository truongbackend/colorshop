                    ...
                    <div data-repeater-list="outer-group" class="outer">
                        <div data-repeater-item="" class="outer">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="taskname" name="maximum" type="number" class="form-control" placeholder="Số lượng...">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Thời gian</label>
                                <div class="col-md-10">
                                    <input class="form-control" name="expiry_period" type="datetime-local" value="2019-08-19T13:45:00" id="example-datetime-local-input">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-lg-10">
                                    <input id="taskname" name="voucher_code" type="text" class="form-control" placeholder="Mã giảm giá ví dụ: abv22...">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label for="taskname" class="col-form-label col-lg-2">Mã giảm giá</label>
                                <div class="col-lg-10">
                                    <input id="taskname" name="voucher_price" type="text" class="form-control" placeholder="Mã giảm giá ...">
                                </div>
                            </div>
                        </div>
                    </div>
